    ...
    <div className="min-h-screen w-full bg-[#f2f2f2] text-black flex items-center justify-center overflow-hidden">
      <div className="absolute h-[90vh] w-[90vw] bg-white rounded-4xl shadow-xl">
        {[
          ...
          { src: "/assets/img14.jpg", className: "top-[3%] left-[50%] w-[124px]" },
        ...
        {/* Text Content */}
        <div className="absolute top-[50%] left-[35%] leading-16 text-[3rem] text-center font-bold -translate-y-1/2">
          Trusted By Leaders <br />
          <span className="text-green-600">From Various Industries</span>
        </div>

        <p className="absolute text-black bottom-[21%] text-center left-[42%] text-[1rem]">
